						...
						<div class="col-lg-4">
							<div class="page-header-breadcrumb">
								<ul class="breadcrumb-title">
									...
									<li class="breadcrumb-item"><a href="#!">Perbaharui Data Kategori</a>
									</li>
								</ul>
							</div>
						</div>
								...
								<div class="card-block">
									...
									<form action="<?= base_url('Admin/cKategori/update/' . $kategori->id_kategori) ?>" method="POST">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" value="<?= $kategori->nama_kategori ?>" name="nama" class="form-control" placeholder="Masukkan Data Nama Kategori">
