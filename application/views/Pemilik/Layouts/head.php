...
<head>
	...
	<!-- Favicon icon -->
	<link rel="icon" href="<?= base_url('asset/guruable-master/') ?>assets/images/favicon.ico" type="image/x-icon">
	<!-- Google font-->
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url('asset/guruable-master/') ?>assets/css/jquery.mCustomScrollbar.css">
</head>
